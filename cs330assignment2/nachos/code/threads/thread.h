...
class NachOSThread {
  ...
  public:
    ...
    void ThreadStackAllocate(VoidFunctionPtr func, int arg);  // Allocate a stack for the simulated thread context. The thread starts execution at
  ...
  private:
    ...
    int recentCPUusage;             // The most recent CPU usage of this thread
...
// while executing kernel code.
  ...
  public:
    ...
    void DecayCPU() { recentCPUusage = recentCPUusage/2; }  // Decay the CPU usage of the thread
