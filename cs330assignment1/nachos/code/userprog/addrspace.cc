...
// first, set up the translation 
	...
	pageTable[i].virtualPage = i;	// for now, virtual page # = phys page # + totalAllocatedPages
	pageTable[i].physicalPage = i + totalAllocatedPages; // append the new phys pages after the currently allocated pages
